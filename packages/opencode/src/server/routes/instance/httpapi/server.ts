...
import { instanceHandlers, transcribeRoute } from "./handlers/instance"
...
const rawInstanceRoutes = Layer.mergeAll(ptyConnectRoute, transcribeRoute).pipe(Layer.provide(instanceRouterLayer))
